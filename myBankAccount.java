...
class Bank{
    public static void main(String[] args){
        myBankAccount a1= new myBankAccount("SB","Sanket","Mahaveer nagar Belagavi",348732.00);
        myBankAccount a2= new myBankAccount("FD","Sandesh","Sadhasiv nagar Belagavi",254321.00);
        myBankAccount a3= new myBankAccount("RD","Shreehari","Bhagyanagar Belagavi",2354234.00);
